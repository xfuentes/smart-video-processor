...
import {Container, FFprobe} from "../../../src/common/programs/FFprobe";

const nodeFs = require("fs");

const genSpawnSpyFileInfo = (origPath: string, origJsonFileName: string, processedJsonFileName: string) => vi.spyOn(Processes, "spawn").mockImplementation(
