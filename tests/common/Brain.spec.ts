...
test('Paw Patrol vo mistake bug', () => {
  currentSettings.isTrackFilteringEnabled = true
  currentSettings.favoriteLanguages = ['fr-FR']
  currentSettings.isKeepVOEnabled = true
  const results = Brain.getInstance().analyse(
    pawPatrol,
    getFakeAbsolutePath("La Pat'Patrouille - S08E01 - Galinetta et Roucoco.mkv"),
    "La Pat'Patrouille - S08E01 - Galinetta et Roucoco",
    {
      path: '/tmp/svp-tmp/e1136705-c44e-40aa-91a3-01bd88209332/TVDB-272472-episode-S08E01.jpg',
      filename: 'cover.jpg',
      description: 'TVDB Image https://artworks.thetvdb.com/banners/v4/episode/8434000/screencap/61f9255e1bac0.jpg',
      mimeType: 'image/jpeg'
    },
    "La Pat'Patrouille - S08E01 - Galinetta et Roucoco",
    [
    ...
    0,
    Languages.getLanguageByCode('en-CA'),
    [Countries.getCountryByCode('CA')],
    [],
    [
      {
        trackId: 1,
