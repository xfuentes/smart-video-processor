...
import {HintType} from "../../src/common/Hint";
...
test('Analysis of Quest for Fire', () => {
    const results = Brain.getInstance().analyse(questOfFireTracks,
...
test('Nobody Has to Know', () => {
    const results = Brain.getInstance().analyse(nobodyHasToKnowTracks,
...
test('Mes meilleurs copains issue', () => {
    const results = Brain.getInstance().analyse(mesMeilleursCopainsTracks,
        "C:\\Download\\hommes-grosses.mkv",
        "Les hommes preferent les grosses",
        defaultPoster1,
        "Les hommes preferent les grosses By Team XYZ",
...
test('La soif de l or issue', () => {
    const results = Brain.getInstance().analyse(laSoifDeLorTracks,
        "C:\\Download\\hommes-grosses.mkv",
        "Les hommes preferent les grosses",
        defaultPoster1,
        "Les hommes preferent les grosses By Team XYZ",
...
test('Le nouveau protocole fake for coverage', () => {
    const results = Brain.getInstance().analyse(leNouveauProtocoleTracks,
        "C:\\Download\\hommes-grosses.mkv",
        "Les hommes preferent les grosses",
        defaultPoster1,
        "Les hommes preferent les grosses By Team XYZ",
...
test('Les hommes preferent les grosses', () => {
    const results = Brain.getInstance().analyse(lesHommesPreferentLesGrossesTracks,
        "C:\\Download\\hommes-grosses.mkv",
        "Les hommes preferent les grosses",
        defaultPoster1,
        "Les hommes preferent les grosses By Team XYZ",
...
test('Les hommes preferent les grosses fake for coverage 1', () => {
    const results = Brain.getInstance().analyse(lesHommesPreferentLesGrossesFake1Tracks,
        "C:\\Download\\hommes-grosses.mkv",
        "Les hommes preferent les grosses",
        defaultPoster1,
        "Les hommes preferent les grosses By Team XYZ",
...
test('Les hommes preferent les grosses fake for coverage 2', () => {
    const results = Brain.getInstance().analyse(lesHommesPreferentLesGrossesFake2Tracks,
        "C:\\Download\\hommes-grosses.mkv",
        "Les hommes preferent les grosses",
        defaultPoster1,
        "Les hommes preferent les grosses By Team XYZ",
...
test('Les hommes preferent les grosses fake for coverage 3', () => {
    let results = Brain.getInstance().analyse(lesHommesPreferentLesGrossesFake3Tracks,
        "C:\\Download\\hommes-grosses.mkv",
        "Les hommes preferent les grosses",
        defaultPoster1,
        "Les hommes preferent les grosses By Team XYZ",
    ...
    results = Brain.getInstance().analyse(lesHommesPreferentLesGrossesFake3Tracks,
        "C:\\Download\\hommes-grosses.mkv",
        "Les hommes preferent les grosses",
        defaultPoster1,
        "Les hommes preferent les grosses By Team XYZ",
...
test('Les hommes preferent les grosses fake for coverage 4', () => {
    let results = Brain.getInstance().analyse(lesHommesPreferentLesGrossesFake4Tracks,
        "C:\\Download\\hommes-grosses.mkv",
        "Les hommes preferent les grosses",
        defaultPoster1,
        "Les hommes preferent les grosses By Team XYZ",
    ...
    results = Brain.getInstance().analyse(lesHommesPreferentLesGrossesFake4Tracks,
        "C:\\Download\\hommes-grosses.mkv",
        "Les hommes preferent les grosses",
        defaultPoster1,
        "Les hommes preferent les grosses By Team XYZ",
        undefined, 0,
        Languages.getLanguageByCode("fr-FR"), [], [{"key": "VF", "pattern": /(\s+VF\s+|FRENCH)/i, "alpha2": "fr"}], userHints);
...
test('Nobody Has to Know 2 faked', () => {
    let results = Brain.getInstance().analyse(nobodyHasToKnow2Tracks,
    ...
    results = Brain.getInstance().analyse(nobodyHasToKnow2Tracks,
        "C:\\Download\\nobody-has-to-know.mkv",
        "Nobody Has to Know",
        defaultPoster1,
        "Nobody Has to Know By Team XYZ",
        undefined, 0,
        Languages.getLanguageByCode("en-GB"), [], [], userHints);
    const changes = changeListToMap(results.changes);
...
test('Nobody Has to Know 3 faked', () => {
    let results = Brain.getInstance().analyse(nobodyHasToKnow3Tracks,
        "C:\\Download\\nobody-has-to-know.mkv",
        "Nobody Has to Know",
        defaultPoster1,
        "Nobody Has to Know By Team XYZ",
    ...
    results = Brain.getInstance().analyse(nobodyHasToKnow3Tracks,
        "C:\\Download\\nobody-has-to-know.mkv",
        "Nobody Has to Know",
        defaultPoster1,
        "Nobody Has to Know By Team XYZ",
        undefined, 0,
        Languages.getLanguageByCode("fr-FR"), [], [], results.hints);
    const changes = changeListToMap(results.changes);
...
test('Savate Bad Attachments Tests', () => {
    const results = Brain.getInstance().analyse(savateBadAttachmentsTracks,
        "C:\\Download\\savate.mkv",
        "Savate",
        defaultPoster1,
        "Savate By Team XYZ",
        savateBadAttachmentsAttachments, 2,
    ...
    expect(!!(changes["Container"]["Update_Poster Image"]?.newValue as Attachment).path, "Poster path defined ?").toBe(true);
    ...
    expect(!!(changes["Container"]["Update_Poster Image"]?.currentValue as Attachment).path, "Poster path defined ?").toBe(false);
});
...
test('Savate Bad Attachments Tests clear', () => {
    const results = Brain.getInstance().analyse(savateBadAttachmentsTracks,
        ...
        defaultPoster1,
        "Savate By Team XYZ",
        savateBadAttachmentsAttachments2, 5,
        Languages.getLanguageByCode("en-US"), [], [], []);
    expect(results.changes.length, "Number of changes").toBeGreaterThanOrEqual(8);
    expect(results.hints.length).toBe(1);
    const changes = changeListToMap(results.changes);
...
test('Capitaine Marleau undefined and qad cases', () => {
    ...
    const results = Brain.getInstance().analyse(tracks,
...
test('Nefarious brain', () => {
    const results = Brain.getInstance().analyse(nefariousTracks,
        "C:\\Ripped\\nefarious (2023).mkv",
        "Nefarious",
        defaultPoster1,
        "Nefarious XYZ",
...
test('Guadalupe Already Processed Brain', () => {
    const results = Brain.getInstance().analyse(guadalupeTracks,
...
test('Ash brain', () => {
    const results = Brain.getInstance().analyse(ashTracks,
...
test('Cowboy Pacifiste', () => {
    const results = Brain.getInstance().analyse(cowboyPacifisteTracks,
...
test('Saving Private Ryan', () => {
    const results = Brain.getInstance().analyse(savingPrivateRyanTracks,
...
test('Hold Out', () => {
    ...
    currentSettings.isKeepVOEnabled = true;
    const results = Brain.getInstance().analyse(holdOutTracks,
        "C:\\Download\\Hold Out (2022).mp4",
        "Hold Out (2022)",
        defaultPoster1,
        "Hold Out (2022)",
        [], 0,
        Languages.getLanguageByCode("fr-FR"),[Countries.getCountryByCode("FR")],  [], []);
...
test('Chickenhare guess of french language', () => {
    ...
    currentSettings.favoriteLanguages = ["fr-FR"];
    currentSettings.isKeepVOEnabled = true;
    const results = Brain.getInstance().analyse(chickenHareTracks,
...
test('10x10 wrong VO for french language', () => {
    ...
    currentSettings.favoriteLanguages = ["fr-FR"];
    currentSettings.isKeepVOEnabled = true;
    const results = Brain.getInstance().analyse(tenxtenTracks,
...
test('Twelve rounds no language on sub track bug', () => {
    ...
    currentSettings.favoriteLanguages = ["fr-FR"];
    currentSettings.isKeepVOEnabled = true;
    const results = Brain.getInstance().analyse(twelveRoundsTracks,
...
test('Savable sub track removal bug', () => {
    ...
    currentSettings.favoriteLanguages = ["fr-FR"];
    currentSettings.isKeepVOEnabled = true;
    const results = Brain.getInstance().analyse(salvableTracks,
...
test('A Working Man language selection bug', () => {
    ...
    currentSettings.favoriteLanguages = ["fr-FR"];
    currentSettings.isKeepVOEnabled = true;
    const results = Brain.getInstance().analyse(workingManTracks,
...
test('Captain America Civil War SDH bug', () => {
    ...
    currentSettings.favoriteLanguages = ["fr-FR"];
    currentSettings.isKeepVOEnabled = true;
    const results = Brain.getInstance().analyse(captainAmericaTracks,
...
test('Passion Of Christ wrongly delete aramaic track bug', () => {
    ...
    currentSettings.favoriteLanguages = ["fr-FR"];
    currentSettings.isKeepVOEnabled = true;
    const results = Brain.getInstance().analyse(passionOfChristTracks,
...
test('Will Hunting SDH deleted bug', () => {
    ...
    currentSettings.favoriteLanguages = ["fr-FR"];
    currentSettings.isKeepVOEnabled = true;
    const results = Brain.getInstance().analyse(willHuntingTracks,
...
test('Star Wars Clone VFQ no delete bug', () => {
    ...
    currentSettings.favoriteLanguages = ["fr-FR"];
    currentSettings.isKeepVOEnabled = true;
    const results = Brain.getInstance().analyse(starWarsCloneTracks,
...
test('Superman 2 delete VO bug', () => {
    ...
    currentSettings.favoriteLanguages = ["fr-FR"];
    currentSettings.isKeepVOEnabled = true;
    const results = Brain.getInstance().analyse(superman2Tracks,
...
test('Morgan delete unknown language bug', () => {
    ...
    currentSettings.favoriteLanguages = ["fr-FR"];
    currentSettings.isKeepVOEnabled = true;
    const results = Brain.getInstance().analyse(morganTracks,
...
test('Hacker VO delete bug', () => {
    ...
    currentSettings.favoriteLanguages = ["fr-FR"];
    currentSettings.isKeepVOEnabled = true;
    const results = Brain.getInstance().analyse(hackerTracks,
...
test('Blue bloods bug', () => {
    ...
    currentSettings.favoriteLanguages = ["fr-FR"];
    currentSettings.isKeepVOEnabled = true;
    const results = Brain.getInstance().analyse(blueBloods,
