...
const languages: LanguageIETF[] = [
    ...
    {code: 'cu', label: 'Church Slavonic', altCodes: ['chu'], matchNames: ['Old Bulgarian', 'Church Slavic', 'Old Slavonic']},
    ...
    {code: 'nr', label: 'South Ndebele', altCodes: ['nbl'], matchNames: ['Ndebele, South', 'Southern Ndebele']},
    {code: 'nd', label: 'North Ndebele', altCodes: ['nde'], matchNames: ['Ndebele, North', 'Northern Ndebele']},
    ...
    {code: 'zh-TW', label: 'Chinese (Taiwan)', altCodes: ['zhtw'], matchNames: ['Chinese'], matchCountries: ['Taiwan']},
    ...
    {code: 'fr', label: 'French', altCodes: ['fre', 'fra'], matchNames: ['French', 'Français', 'Francais'], isRegionImportant: true},
    {code: 'fr-CA', label: 'French (Canada)', matchNames: ['French', 'Français'], matchCountries: ['Canada', 'CA']},
    {code: 'fr-FR', label: 'French (France)', matchNames: ['French', 'Français'], matchCountries: ['France', 'FR']},
    {code: 'fr-CH', label: 'French (Switzerland)', matchNames: ['French', 'Français'], matchCountries: ['Switzerland', 'Suisse', 'CH']},
...
export default class Languages {
    ...
    static descriptionMatchLanguage(description: string, lang: LanguageIETF): boolean {
        ...
        langCodePat = langCodePat.length > 0 && altCodesPat.length > 0 ? `${langCodePat}|${altCodesPat}`:langCodePat+altCodesPat;
        const codePattern = new RegExp(prev + `(?:${langCodePat})` + next, "u");
        const descPat = prev + lang.label + next;

        if (new RegExp(codePattern, "u").exec("\n" + description + "\n") !== null ||
    ...
    static searchByNameOrCode(input: string) {
        ...
        return languages.filter(lang => {
            return lang.code.toLocaleLowerCase().indexOf(loweredInput) !== -1
