...
import {FFmpeg} from "../programs/FFmpeg.ts";
import {EncoderSettings} from "../Encoding.ts";
import Strings from "../../util/strings.ts";
import Track from "../Track.ts";

export default class EncodingJob extends Job<string> {
    ...
    protected executeInternal(): Promise<string> {
        return FFmpeg.getInstance().encodeFile(this.path, this.durationSeconds, this.tracks, this.settings, this.setProgression.bind(this));
    }
}
