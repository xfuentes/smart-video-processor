...
const countries: Country[] = [
    ...
    {id: "275", label: "Palestine, State of", alias: "Palestinian Territory", alpha2: "PS", alpha3: "PSE"},
    ...
    {id: "850", label: "Virgin Islands (U.S.)", alias: "Virgin Islands US", alpha2: "VI", alpha3: "VIR"},
