...
export class SearchResult {
    ...
    constructor(id: number, title: string, year: number | undefined, originalTitle: string, overview: string,
                poster: string | undefined, language: LanguageIETF | undefined = undefined, countries: Country[] = [],
                imdb: string | undefined = undefined, note: number | undefined = undefined) {
        this.id = id;
        this.title = title;
        this.year = year;
