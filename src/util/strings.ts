...
export default class Strings {
    static humanBitrate(value: number | undefined, binary: boolean = false, isBytes: boolean = false, isRate: boolean = true) {
        if (value === undefined) {
            return "";
        }
    ...
    static pixelsToVideoFormat(pixels: string): VideoFormats {
        ...
        let widthShorterDistance = undefined;
        ...
        let heightShorterDistance = undefined;
    ...
    static pixelsToQuality(pixels: string): {index: number, shortName: string, longName: string, badge: "bronze" | "silver" | "gold"} {
